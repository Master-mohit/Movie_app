    ...
    <i class="mr-3 text-[#6556CD] ri-tv-fill"></i>  
     <span className='text-white font-bold'>MNMA.</span>
      ...
      <nav className='flex flex-col gap-3 text-xl text-zinc-400'>
         ...
         <Link to="/tv" className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4'> <i class="mr-2 ri-tv-2-fill"></i>Tv Shows</Link>
         <Link to="/people" className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4'><i class="mr-2 ri-team-fill"></i>Peoples</Link>
      </nav>
