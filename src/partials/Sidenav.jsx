    ...
    <i class="mr-3 text-[#6556CD] ri-tv-fill"></i>  
     <span className='text-white font-bold'>MNMA.</span>
      ...
      <nav className='flex flex-col gap-3 text-xl text-zinc-400'>
         ...
         <Link className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4'> <i class=" mr-2 ri-fire-fill"></i>Tranding</Link>
         <Link  className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4'><i class="mr-2 ri-bard-fill"></i>Popular</Link>
         <Link  className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4'><i class=" mr-2 ri-movie-ai-fill"></i>Movies</Link>
